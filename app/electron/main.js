const { app, protocol, session, BrowserWindow, ipcMain } = require("electron")
...
const selfHost = `http://localhost:${port}#/home`
...
async function createWindow() {
  ...
  if (isDev) {
    ...
    win.loadURL(`${Protocol.scheme}://rse/index.html#/home`)
  }

  // show the app screen after when ready
